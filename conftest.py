...
# Заменил фикстуру финализации на хук вызывающийся в конце тестоа:
def pytest_sessionfinish(session, exitstatus):
    """Этот хук вызывается ОДИН РАЗ в самом конце сессии.Allure обычно не привязывает это к каждому тесту."""
    print("\n[HOOK] Завершение сессии...")
    AppFixture.session.Ensure_logout()
    AppFixture.Destroy()
